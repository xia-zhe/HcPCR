...
from src.fns import *
from src.model.hcpcrpp import HcPCRPP
...
if __name__ == '__main__':
    parser = main_hcpcrpp.get_args_parser()
    ...
    parser.add_argument('--checkpoint', default='pretrained/hcpcrpp.pth', type=str, help='model checkpoint')
