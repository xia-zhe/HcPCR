...
def get_args_parser():
    parser = argparse.ArgumentParser('HcPCR++', add_help=False)
    ...
    parser.add_argument('--output_dir', default='./output_dir',
                        help='Path to where to save, empty for no saving')
    parser.add_argument('--exp_name', default='hcpcrpp',
    ...
    # CO3D
    parser.add_argument('--co3d_path', type=str, default='/C/co3d_data',
